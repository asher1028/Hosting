...
<head>
    ...
    <script>
       function baptism() { window.location.href = 'userBaptismSchedule.php'; }
       function wedding() { window.location.href = 'userWeddingSchedule.php'; }
    </script>
    <style>
        body {
...
<body>
    ...
    <div id="aboutDiv" style ='background-color: white; margin-top: 100px;' 
        }>
        <h1 style ="margin-top : 20px;" class="text-center">SEVEN CATHOLIC SACRAMENTS</h1>
