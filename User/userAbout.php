                ...
                <div id="logosDiv" class="d-flex">
                    ...
                    <div class="logoContainer">
                        ...
                        <div id="quickLinksSection">
                            ...
                            <a href="userBaptismApplication.php" id="baptismLink" class="quickLinks">Baptism</a>
                            <a href="userWeddingApplication.php" id="weddingLink" class="quickLinks">Wedding</a>
                            <a href="userFuneralScheduleApplication.php" id="funeralLink" class="quickLinks">Funeral</a>
